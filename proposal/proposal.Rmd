...
This dataset is derived from the [**\underline{World Happiness Report}**](https://worldhappiness.report/).
...
## **Data Dictionary**
The data dictionary can be found [**\underline{here}**](https://github.com/nimyou/world-happiness-report/blob/main/data/README.md).
